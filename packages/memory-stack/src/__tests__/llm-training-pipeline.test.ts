...
describe('Brain Pipeline Sensory Cortex Integration', () => {
  ...
  it('should include Sensory Cortex in health report (29 regions)', () => {
    ...
    // Brain Analog: Neurological exam now tests 30 regions including Motor Cortex, cognitive stack layers, and CTO Performance Tracker
    expect(health.regions).toHaveLength(30);
  ...
  it('should have all 29 brain regions with correct analogs', () => {
    const brain = createBrainPipeline({
      supabase,
      organizationId: 'org-test',
    });
