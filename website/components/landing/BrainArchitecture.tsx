...
const BRAIN_REGIONS = [
  {
    ...
    description: "Ingests data from 16 connectors, public datasets (FRED, BLS, GitHub), and the internet. LLM-powered knowledge distillation extracts causal patterns from domain literature. Zero privacy risk — public data only.",
  ...
  },
  {
    ...
    shortDesc: "9 methods, one verdict",
    description: "Calibrated ensemble of 9 advanced causal methods: conditional multivariate Granger (controls for all confounders), cascade-aware scoring, nonlinear analysis, PC algorithm, do-calculus, transfer entropy, and more. Methods vote together — not correlation, proven causation.",
    color: "from-violet-400 to-purple-400",
    textColor: "text-violet-400",
    borderColor: "border-violet-400/30",
    bgColor: "bg-violet-400/10",
    analogy: "Like how your brain doesn't just notice patterns — it reasons about WHY things happen. 9 algorithms voting together with statistical rigor.",
    category: "realtime",
  },
  {
    id: "emotional",
