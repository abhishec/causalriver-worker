    ...
    const packs: TrainingPack[] = [
      {
        ...
        businessRules: [
          ...
          { id: 'my-epf-employer', condition: 'jurisdiction = my AND my_employee', action: 'Employer EPF: 13% of wages ≤RM5,000, 12% above. Employee: 9% (age <60). Debit EPF Expense, Credit EPF Payable. Remit via i-Akaun by 15th of following month.', confidence: 1.0, source: 'epf_kwsp_contribution_rates_2024' },
          { id: 'my-corp-tax', condition: 'jurisdiction = my AND my_resident_company', action: 'MY Corporate Tax: 24% for Sdn Bhd with paid-up capital >RM2.5M. SME preferential rate: 17% on first RM600,000 chargeable income (paid-up <RM2.5M and NOT related to company with paid-up >RM2.5M). File Form C by 7 months after year end.', confidence: 1.0, source: 'lhdn_form_c_guide' },
        ],
        cascades: [],
