...
export const WIKIPEDIA_KNOWLEDGE_CATALOG: Array<{
  ...
  // ACCOUNTING & FP&A
  // ═══════════════════════════════════════════════════════════════════════════
  { title: 'Double-entry_bookkeeping', domain: 'finance', subDomain: 'accounting' },
  { title: 'Depreciation', domain: 'finance', subDomain: 'accounting' },
  { title: 'International_Financial_Reporting_Standards', domain: 'finance', subDomain: 'accounting' },
  { title: 'Generally_Accepted_Accounting_Principles_(United_States)', domain: 'finance', subDomain: 'accounting' },
  { title: 'Accounts_receivable', domain: 'finance', subDomain: 'accounting' },
  { title: 'Accounts_payable', domain: 'finance', subDomain: 'accounting' },
  { title: 'Balance_sheet', domain: 'finance', subDomain: 'accounting' },
  { title: 'Income_statement', domain: 'finance', subDomain: 'accounting' },
  { title: 'Cash_flow_statement', domain: 'finance', subDomain: 'accounting' },
  { title: 'Trial_balance', domain: 'finance', subDomain: 'accounting' },
  { title: 'General_ledger', domain: 'finance', subDomain: 'accounting' },
  { title: 'Accrual', domain: 'finance', subDomain: 'accounting' },
  { title: 'Amortization_(business)', domain: 'finance', subDomain: 'accounting' },
  { title: 'DuPont_analysis', domain: 'finance', subDomain: 'accounting' },
  { title: 'Working_capital', domain: 'finance', subDomain: 'accounting' },
  { title: 'Days_sales_outstanding', domain: 'finance', subDomain: 'accounting' },
  { title: 'Days_payable_outstanding', domain: 'finance', subDomain: 'accounting' },
  { title: 'Days_inventory_outstanding', domain: 'finance', subDomain: 'accounting' },
  { title: 'Current_ratio', domain: 'finance', subDomain: 'accounting' },
  { title: 'Quick_ratio', domain: 'finance', subDomain: 'accounting' },
  { title: 'Return_on_equity', domain: 'finance', subDomain: 'accounting' },
  { title: 'Return_on_assets', domain: 'finance', subDomain: 'accounting' },
  { title: 'Inventory_turnover', domain: 'finance', subDomain: 'accounting' },
  { title: 'Gross_profit', domain: 'finance', subDomain: 'accounting' },
  { title: 'Net_income', domain: 'finance', subDomain: 'accounting' },
  { title: 'Sarbanes%E2%80%93Oxley_Act', domain: 'finance', subDomain: 'accounting' },
  { title: 'Revenue_recognition', domain: 'finance', subDomain: 'accounting' },
  { title: 'Deferred_revenue', domain: 'finance', subDomain: 'accounting' },
  { title: 'Goodwill_(accounting)', domain: 'finance', subDomain: 'accounting' },
  { title: 'Fair_value', domain: 'finance', subDomain: 'accounting' },
  { title: 'Audit', domain: 'finance', subDomain: 'accounting' },
  { title: 'Internal_audit', domain: 'finance', subDomain: 'accounting' },
  { title: 'Tax_accounting', domain: 'finance', subDomain: 'accounting' },
  { title: 'Cost_accounting', domain: 'finance', subDomain: 'accounting' },
  { title: 'Activity-based_costing', domain: 'finance', subDomain: 'accounting' },
  { title: 'Altman_Z-score', domain: 'finance', subDomain: 'accounting' },

  // ═══════════════════════════════════════════════════════════════════════════
  // FP&A / CAPITAL BUDGETING
  // ═══════════════════════════════════════════════════════════════════════════
  { title: 'Net_present_value', domain: 'finance', subDomain: 'fpa' },
  { title: 'Internal_rate_of_return', domain: 'finance', subDomain: 'fpa' },
  { title: 'Weighted_average_cost_of_capital', domain: 'finance', subDomain: 'fpa' },
  { title: 'Capital_budgeting', domain: 'finance', subDomain: 'fpa' },
  { title: 'Discounted_cash_flow', domain: 'finance', subDomain: 'fpa' },
  { title: 'Payback_period', domain: 'finance', subDomain: 'fpa' },
  { title: 'Zero-based_budgeting', domain: 'finance', subDomain: 'fpa' },
  { title: 'Rolling_forecast', domain: 'finance', subDomain: 'fpa' },
  { title: 'Scenario_planning', domain: 'finance', subDomain: 'fpa' },
  { title: 'Sensitivity_analysis', domain: 'finance', subDomain: 'fpa' },
  { title: 'Monte_Carlo_method', domain: 'finance', subDomain: 'fpa' },
  { title: 'Break-even_(economics)', domain: 'finance', subDomain: 'fpa' },
  { title: 'Economic_value_added', domain: 'finance', subDomain: 'fpa' },
  { title: 'Financial_modeling', domain: 'finance', subDomain: 'fpa' },
  { title: 'Comparable_company_analysis', domain: 'finance', subDomain: 'fpa' },
  { title: 'Enterprise_value', domain: 'finance', subDomain: 'fpa' },
  { title: 'Terminal_value_(finance)', domain: 'finance', subDomain: 'fpa' },
  { title: 'Cost_of_equity', domain: 'finance', subDomain: 'fpa' },
  { title: 'Capital_asset_pricing_model', domain: 'finance', subDomain: 'fpa' },
  { title: 'Beta_(finance)', domain: 'finance', subDomain: 'fpa' },
  { title: 'Hurdle_rate', domain: 'finance', subDomain: 'fpa' },

  // ═══════════════════════════════════════════════════════════════════════════
  // SUPPLY CHAIN & OPERATIONS
  // ═══════════════════════════════════════════════════════════════════════════
  { title: 'Procurement', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Bullwhip_effect', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Economic_order_quantity', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Just-in-time_manufacturing', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Enterprise_resource_planning', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Value-stream_mapping', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Kanban', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Material_requirements_planning', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Vendor-managed_inventory', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Safety_stock', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Total_quality_management', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Overall_equipment_effectiveness', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Warehouse_management_system', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Third-party_logistics', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Last-mile_delivery', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Demand_forecasting', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Supply_chain_resilience', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Nearshoring', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Reshoring', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Cross-docking', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Reverse_logistics', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Kraljic_matrix', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Poka-yoke', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Jidoka', domain: 'strategy', subDomain: 'supply-chain' },
  { title: 'Muda_(Japanese_term)', domain: 'strategy', subDomain: 'supply-chain' },

  // ═══════════════════════════════════════════════════════════════════════════
  // LEGAL & COMPLIANCE
  // ═══════════════════════════════════════════════════════════════════════════
  { title: 'Contract', domain: 'strategy', subDomain: 'legal' },
  { title: 'Intellectual_property', domain: 'strategy', subDomain: 'legal' },
  { title: 'Non-disclosure_agreement', domain: 'strategy', subDomain: 'legal' },
  { title: 'Service-level_agreement', domain: 'strategy', subDomain: 'legal' },
  { title: 'Corporate_governance', domain: 'strategy', subDomain: 'legal' },
  { title: 'Patent', domain: 'strategy', subDomain: 'legal' },
  { title: 'Patent_infringement', domain: 'strategy', subDomain: 'legal' },
  { title: 'Trade_secret', domain: 'strategy', subDomain: 'legal' },
  { title: 'Copyright', domain: 'strategy', subDomain: 'legal' },
  { title: 'Trademark', domain: 'strategy', subDomain: 'legal' },
  { title: 'Non-compete_clause', domain: 'strategy', subDomain: 'legal' },
  { title: 'Indemnity', domain: 'strategy', subDomain: 'legal' },
  { title: 'Liability', domain: 'strategy', subDomain: 'legal' },
  { title: 'Arbitration', domain: 'strategy', subDomain: 'legal' },
  { title: 'General_Data_Protection_Regulation', domain: 'strategy', subDomain: 'legal' },
  { title: 'California_Consumer_Privacy_Act', domain: 'strategy', subDomain: 'legal' },
  { title: 'Anti-money_laundering', domain: 'strategy', subDomain: 'legal' },
  { title: 'Know_your_customer', domain: 'strategy', subDomain: 'legal' },
  { title: 'Patent_troll', domain: 'strategy', subDomain: 'legal' },
  { title: 'Trade_secret', domain: 'strategy', subDomain: 'legal' },
  { title: 'Open-source_license', domain: 'engineering', subDomain: 'legal' },
  { title: 'End-user_license_agreement', domain: 'strategy', subDomain: 'legal' },
  { title: 'Terms_of_service', domain: 'strategy', subDomain: 'legal' },
  { title: 'Employment_contract', domain: 'hr', subDomain: 'legal' },
  { title: 'Class_action', domain: 'strategy', subDomain: 'legal' },

  // ═══════════════════════════════════════════════════════════════════════════
  // BEHAVIORAL ECONOMICS
  // ═══════════════════════════════════════════════════════════════════════════
  { title: 'Loss_aversion', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Nudge_theory', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Anchoring_(cognitive_bias)', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Social_proof', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Gamification', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Cognitive_bias', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Confirmation_bias', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Availability_heuristic', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Bandwagon_effect', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Decoy_effect', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Endowment_effect', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Sunk_cost', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Status_quo_bias', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Scarcity_(social_psychology)', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Choice_architecture', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Default_effect', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Framing_effect_(psychology)', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Dunning%E2%80%93Kruger_effect', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Peak%E2%80%93end_rule', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Reciprocity_(social_psychology)', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Herd_behavior', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Illusory_superiority', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Mental_accounting', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Mere-exposure_effect', domain: 'marketing', subDomain: 'behavioral-econ' },
  { title: 'Fear_of_missing_out', domain: 'marketing', subDomain: 'behavioral-econ' },

  // ═══════════════════════════════════════════════════════════════════════════
  // DATA SCIENCE & ANALYTICS
  // ═══════════════════════════════════════════════════════════════════════════
  { title: 'Data_warehouse', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Extract,_transform,_load', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Star_schema', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Performance_indicator', domain: 'engineering', subDomain: 'analytics' },
  { title: 'A/B_testing', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Data_governance', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Business_intelligence', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Data_lake', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Data_lineage', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Data_quality', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Online_analytical_processing', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Snowflake_schema', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Data_catalog', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Feature_store', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Data_pipeline', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Change_data_capture', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Data-driven_decision-making', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Balanced_scorecard', domain: 'engineering', subDomain: 'analytics' },
  { title: 'OKR', domain: 'engineering', subDomain: 'analytics' },
  { title: 'Cohort_analysis', domain: 'engineering', subDomain: 'analytics' },

  // ═══════════════════════════════════════════════════════════════════════════
  // HEALTHCARE / FINTECH / MANUFACTURING VERTICALS
  // ═══════════════════════════════════════════════════════════════════════════
  { title: 'Electronic_health_record', domain: 'product', subDomain: 'healthcare' },
  { title: 'Telemedicine', domain: 'product', subDomain: 'healthcare' },
  { title: 'Health_Insurance_Portability_and_Accountability_Act', domain: 'product', subDomain: 'healthcare' },
  { title: 'Interoperability', domain: 'engineering', subDomain: 'healthcare' },
  { title: 'Remote_patient_monitoring', domain: 'product', subDomain: 'healthcare' },
  { title: 'Digital_health', domain: 'product', subDomain: 'healthcare' },
  { title: 'Clinical_decision_support_system', domain: 'engineering', subDomain: 'healthcare' },
  { title: 'Open_banking', domain: 'finance', subDomain: 'fintech' },
  { title: 'Neobank', domain: 'finance', subDomain: 'fintech' },
  { title: 'Payment_processor', domain: 'finance', subDomain: 'fintech' },
  { title: 'Buy_now,_pay_later', domain: 'finance', subDomain: 'fintech' },
  { title: 'Embedded_finance', domain: 'finance', subDomain: 'fintech' },
  { title: 'Regulatory_sandbox', domain: 'finance', subDomain: 'fintech' },
  { title: 'Payment_Services_Directive', domain: 'finance', subDomain: 'fintech' },
  { title: 'Mobile_payment', domain: 'finance', subDomain: 'fintech' },
  { title: 'Predictive_maintenance', domain: 'engineering', subDomain: 'manufacturing' },
  { title: 'Internet_of_things', domain: 'engineering', subDomain: 'manufacturing' },
  { title: 'Digital_twin', domain: 'engineering', subDomain: 'manufacturing' },
  { title: 'Industry_4.0', domain: 'engineering', subDomain: 'manufacturing' },
  { title: 'Edge_computing', domain: 'engineering', subDomain: 'manufacturing' },
  { title: 'Programmable_logic_controller', domain: 'engineering', subDomain: 'manufacturing' },
  { title: 'SCADA', domain: 'engineering', subDomain: 'manufacturing' },
  { title: 'Smart_factory', domain: 'engineering', subDomain: 'manufacturing' },
];
