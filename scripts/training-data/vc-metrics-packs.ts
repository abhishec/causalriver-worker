...
const saasUnitEconomics: TrainingPack = {
  ...
  cascades: [
    {
      id: 'unit-economics-death-spiral',
      name: 'Unit Economics Death Spiral',
      stages: [
        { signal: 'rising_cac', domain: 'marketing', description: 'Customer acquisition cost rising 14%+ YoY (2024 trend)' },
        { signal: 'payback_elongation', domain: 'finance', description: 'CAC payback extends from 14 to 18+ months' },
        { signal: 'cash_burn_acceleration', domain: 'finance', description: 'More cash consumed per dollar of ARR acquired' },
        { signal: 'growth_deceleration_pressure', domain: 'finance', description: 'Board pressures for efficiency, growth slows' },
        { signal: 'valuation_compression', domain: 'finance', description: 'Revenue multiples compress from 10x to 5x' },
      ],
      totalLagDays: 270,
      confidence: 0.85,
    },
    {
      id: 'nrr-powered-growth-flywheel',
      name: 'NRR-Powered Growth Flywheel',
      stages: [
        { signal: 'product_value_expansion', domain: 'product', description: 'New features/tiers drive expansion opportunities' },
        { signal: 'nrr_exceeds_110', domain: 'cs', description: 'Net revenue retention crosses 110% threshold' },
        { signal: 'expansion_revenue_compounds', domain: 'finance', description: '30-40% of growth from existing customers' },
        { signal: 'cac_efficiency_improves', domain: 'marketing', description: 'Less spend needed on new logos to hit growth target' },
        { signal: 'valuation_premium', domain: 'finance', description: 'NRR 111%+ → 2.5x higher valuation multiple' },
      ],
      totalLagDays: 180,
      confidence: 0.88,
    },
...
const vcFundingPatterns: TrainingPack = {
  ...
  cascades: [
    {
      id: 'post-fundraise-growth-cascade',
      name: 'Post-Fundraise Growth Cascade',
      stages: [
        { signal: 'funding_round_closes', domain: 'finance', description: 'New capital infusion, 18-24 months runway' },
        { signal: 'hiring_surge', domain: 'hr', description: 'Aggressive hiring: engineering, sales, marketing' },
        { signal: 'velocity_dip', domain: 'product', description: 'New hires slow velocity for 60-90 days (onboarding overhead)' },
        { signal: 'gtm_investment', domain: 'marketing', description: 'Increased sales/marketing spend to accelerate growth' },
        { signal: 'growth_acceleration', domain: 'finance', description: 'ARR growth accelerates as new hires ramp (90-180 days post-funding)' },
      ],
      totalLagDays: 180,
      confidence: 0.82,
    },
  ...
  cascades: [
    {
      ...
      name: 'Growth Efficiency Flywheel',
      stages: [
        { signal: 'margin_improvement', domain: 'finance', description: 'Gross margins improve from 70% to 75%+ through automation and scale' },
        { signal: 'operating_leverage', domain: 'finance', description: 'Fixed costs spread over more revenue, OPEX ratio declines' },
        { signal: 'cash_flow_improvement', domain: 'finance', description: 'Less cash consumed per dollar of growth' },
        { signal: 'reinvestment_capacity', domain: 'finance', description: 'Freed cash reinvested in growth levers with positive ROI' },
        { signal: 'rule_of_40_achievement', domain: 'finance', description: 'Compound effect: growth + margins both improve' },
      ],
      totalLagDays: 365,
      confidence: 0.82,
    },
