...
/**
 * InlineChart renders structured chart data emitted by the LLM inside chat.
 *
 * The LLM outputs a fenced code block with language "chart":
 *
 * ```chart
 * {
 *   "type": "bar" | "line" | "area",
 ...
 *   ],
 *   "data": [
 *     { "date": "Jan 1", "engineering": 42, "financial": 18 },
 *     { "date": "Jan 2", "engineering": 55, "financial": 22 }
 *   ]
 * }
 * ```
 */
...
/**
 * Parses a chart JSON string from a ```chart code block.
