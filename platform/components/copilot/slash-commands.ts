...
const GENERAL_COMMANDS: SlashCommand[] = [
  { id: "causal",       label: "causal-analysis",    icon: "📊", description: "Cross-domain cause-and-effect analysis",     prompt: "Run a causal analysis",          service: "general", category: "Intelligence" },
  ...
  { id: "intel-report", label: "intelligence-report", icon: "📄", description: "Full intelligence report",    prompt: "Give me the full intelligence report",                service: "general", category: "Intelligence" },
