...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Capabilities", href: "/capabilities", icon: "M11.42 15.17l-5.658-3.163A1.114 1.114 0 016 12.513V7.843c0-.387.21-.744.546-.933l5.658-3.163a1.115 1.115 0 011.092 0l5.658 3.163c.336.189.546.546.546.933v4.67c0 .387-.21.744-.546.933l-5.658 3.163a1.115 1.115 0 01-1.092 0z" },
