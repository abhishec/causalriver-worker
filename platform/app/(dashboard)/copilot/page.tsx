...
const SERVICES: ServiceConfig[] = [
  ...
  },
  {
    ...
    pills: [
      { label: "Branch Risk", prompt: "Analyse the selected branch — what has changed, what is the blast radius, and is this ready to release?", category: "engineering" },
      { label: "PR Review", prompt: "Review the latest PR for code quality, security issues, and breaking changes — include confidence score and suggested reviewers", category: "engineering" },
      { label: "Impact Analysis", prompt: "What files and services will break if I change the authentication module? Include downstream dependency chain and test coverage gaps.", category: "engineering" },
      { label: "Cross-Branch", prompt: "Compare the two active release branches. Do they have conflicting changes in any shared modules? Who should coordinate?", category: "engineering" },
      { label: "TDD Generator", prompt: "Generate comprehensive TDD tests for our authentication module — unit, integration, and edge cases", category: "engineering" },
      { label: "Incident RCA", prompt: "Diagnose the root cause of the latest production incident — rank probable causes with evidence from code history and PRs", category: "engineering" },
      { label: "Dead Code", prompt: "Find all dead code, unused exports, and unreachable functions in this branch — include confidence and safe-to-delete verdict", category: "engineering" },
      { label: "Expert Finder", prompt: "Who on the team has the deepest knowledge of the authentication module? Who should review this PR and who is at highest departure risk?", category: "engineering" },
    ],
    examplePrompts: [
      "Analyse the 6.3.4 branch — what's changed and what's the release risk before Apr 7?",
      "Review the latest PR for security issues and breaking API changes",
      "What breaks if I change the auth session manager?",
      "Do our two release branches (6.3.4 and 5.11.5) have conflicting changes?",
      "Who knows the most about our billing module and what's their departure risk?",
      "Generate TDD tests for the payment orchestration service",
    ],
    personaDescription: "Your AI software engineer — branch-scoped code intelligence, PR review, impact analysis, and cross-release risk assessment",
  },
];
