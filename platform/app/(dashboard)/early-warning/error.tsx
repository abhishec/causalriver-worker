...
export default function EarlyWarningError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Early Warning page error:", error);
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
      ...
      <h2 className="text-lg font-semibold mb-1">Failed to load early warnings</h2>
      <p className="text-xs text-muted mb-1 max-w-md text-center">
        Early warnings couldn't load — check your connection and try again.
      </p>
      {error.digest && (
