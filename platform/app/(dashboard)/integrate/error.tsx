...
export default function IntegrateError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Integrate page error:", error);
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
      ...
      <h2 className="text-lg font-semibold mb-1">Failed to load integrations</h2>
      <p className="text-xs text-muted mb-1 max-w-md text-center">
        Integrations couldn't load — check your connection and try again.
      </p>
      {error.digest && (
